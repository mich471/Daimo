...
class Productcollection extends \Lof\AdvancedReports\Model\ResourceModel\AbstractReport\Ordercollection
{
	/**
     * Store ids
     *
    ...
    protected function _applyOrderStatusFilter()
    {
        ...
        $this->getSelect()->where('main_table.status IN(?)', $orderStatus);
        return $this;
    }
