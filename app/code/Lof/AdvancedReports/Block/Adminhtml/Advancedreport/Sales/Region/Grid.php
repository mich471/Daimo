...
namespace Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Sales\Region;
...
class Grid extends \Lof\AdvancedReports\Block\Adminhtml\Grid\AbstractGrid {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType( '*/*/exportSalesByRegionCsv', __( 'CSV' ) );
        $this->addExportType( '*/*/exportSalesByRegionExcel', __( 'Excel XML' ) );
