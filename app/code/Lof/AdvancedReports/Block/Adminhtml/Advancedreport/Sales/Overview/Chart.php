...
class Chart extends \Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Chart {
    ...
    public function initOverviewChart()
    {
        ...
        $settings['columns_array'] = [
            "total_revenue_amount"    => [ __( "Date" ), __( "Revenue" ), '{ role: "style" }' ],
            "total_grandtotal_amount" => [ __( "Date" ), __( "Total" ), '{ role: "style" }' ],
            "total_subtotal_amount"   => [ __( "Date" ), __( "Subtotal" ), '{ role: "style" }' ],
            "orders_count"            => [ __( "Date" ), __( "Number Of Orders" ), '{ role: "style" }' ],
            "total_qty_ordered"       => [ __( "Date" ), __( "Items Ordered" ), '{ role: "style" }' ],
        ];
    ...
    protected function _getOverviewChartData( $settings = [], $show_by = "total_revenue_amount" )
    {
