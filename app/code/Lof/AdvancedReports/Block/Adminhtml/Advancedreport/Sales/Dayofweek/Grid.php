 ...
 */
namespace Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Sales\Dayofweek;
...
class Grid extends \Lof\AdvancedReports\Block\Adminhtml\Grid\AbstractGrid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('*/*/exportSalesDayOfWeekCsv', __('CSV'));
        $this->addExportType('*/*/exportSalesDayOfWeekExcel', __('Excel XML'));
        // }
