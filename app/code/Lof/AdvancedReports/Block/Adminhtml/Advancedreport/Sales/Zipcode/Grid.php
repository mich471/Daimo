...
namespace Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Sales\Zipcode;
...
class Grid extends \Lof\AdvancedReports\Block\Adminhtml\Grid\AbstractGrid {
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addExportType('*/*/exportSalesByZipcodeCsv', __('CSV'));
        $this->addExportType('*/*/exportSalesByZipcodeExcel', __('Excel XML'));
