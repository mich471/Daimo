...
namespace Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Sales\Productcountry;
...
class Grid extends \Lof\AdvancedReports\Block\Adminhtml\Grid\AbstractGrid {
    ...
    protected function _prepareCollection()
    {
        ...
        $product_sku_field = $filterData->getData( "product_sku", null );
        ...
        $resourceCollection = $this->_objectManager->create( $this->getResourceCollectionName() )
                                                   ...
                                                   ->addProductSkuFilter( $product_sku_field )
        ...
        $resourceCollection->applyProductFilter();
