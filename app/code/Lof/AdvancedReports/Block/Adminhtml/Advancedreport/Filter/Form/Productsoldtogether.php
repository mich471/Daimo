 ...
 */
class Productsoldtogether extends \Lof\AdvancedReports\Block\Adminhtml\Advancedreport\Filter\Form
{
    protected function _prepareForm()
    {
        ...
        $htmlIdPrefix = 'productsoldtogether_report_';
       ...
       $values = array();
        ...
        $fieldset->addField('reportrange', 'date_range', [
            ...
            'target_from'   => '#productsoldtogether_report_filter_from',
            'target_to'     => '#productsoldtogether_report_filter_to',
