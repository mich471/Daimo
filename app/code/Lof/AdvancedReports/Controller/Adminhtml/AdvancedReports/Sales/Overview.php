...
class Overview extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesoverview'
        )->_addBreadcrumb(
            __('Sales Overview'),
            __('Sales Overview')
        );
        $this->_registry->register('report_type', "overview");
        $this->_registry->register('header_text', __("Sales Overview"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Overview'));

        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_overview.grid');
        $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'overview');
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Lof_AdvancedReports::salesoverview');
    }
