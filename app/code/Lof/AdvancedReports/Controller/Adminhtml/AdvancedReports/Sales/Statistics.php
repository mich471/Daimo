...
class Statistics extends \Lof\AdvancedReports\Controller\Adminhtml\AdvancedReports\Sales
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_initAction()->_setActiveMenu(
            'Lof_AdvancedReports::salesstatistics'
        )->_addBreadcrumb(
            __('Sales Statistics'),
            __('Sales Statistics')
        );
        $this->_registry->register('report_type', "statistics");
        $this->_registry->register('header_text', __("Sales Statistics"));
        $this->_view->getPage()->getConfig()->getTitle()->prepend(__('Sales Statistics'));
        $chartBlock = $this->_view->getLayout()->getBlock('report.chart');
        $gridBlock = $this->_view->getLayout()->getBlock('adminhtml_advancedreport_sales_statistics.grid');
        $filterFormBlock = $this->_view->getLayout()->getBlock('grid.filter.form');
        $this->_initReportAction([$gridBlock, $filterFormBlock,$chartBlock], 'statistics');
