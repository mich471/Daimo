...
class Post extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $type = $data['type'];
        $text = 'question';
        $messageSuccess = __('Sua pergunta foi enviada para moderação.', $text);
        ...
        switch ($type) {
            case '2':
                ...
                if ($this->questionData->getAutoApprovalNewAnswer()) {
                    ...
                    $messageSuccess = __('Você submeteu sua %1 com sucesso.', $text);
                }
            ...
            case '1':
                ...
                if ($this->questionData->getAutoApprovalNewQuestion()) {
                    ...
                    $data['question_status_id'] = \PHPCuong\ProductQuestionAndAnswer\Model\Status::STATUS_PENDING;
                }
                break;
            default:
        ...
        try {
            ...
            $data['product_idseller'] = $product->getSellerId();
            $data['product_url'] = $product->getUrlKey();
