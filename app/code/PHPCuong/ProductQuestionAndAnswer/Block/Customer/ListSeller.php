 ...
 */
class ListSeller extends \Magento\Customer\Block\Account\Dashboard
{
    /**
    ...
    public function getQuestions()
    {
        ...
        if (!$this->collection) {
            ...
            $this->collection
                ...
                ->setProductName()
                ->addFieldToFilter("question_status_id", ["eq" => 1])
                ->addFieldToFilter("product_idseller", ["eq" => $customerId])
                ->setDateOrder();
        }
    ...
    {
        return $this->formatDateTime->formatCreatedAtWithTime($date);
    }
    ...
    protected function getAnswerInfo($answer)
    {
        ...
        return $this->dataObjectFactory->create()
            ...
            ->setCreatedAt($this->formatDateTime->formatCreatedAtWithTime($answer->getAnswerCreatedAt()))
            ->getData();
    }
