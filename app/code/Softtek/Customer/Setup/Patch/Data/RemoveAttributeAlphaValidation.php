 ...
 */
class RemoveAttributeAlphaValidation implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->updateAttribute(Customer::ENTITY, 'firstname', ['frontend_class' => '']);
        $eavSetup->updateAttribute(Customer::ENTITY, 'lastname', ['frontend_class' => '']);
