...
namespace Softtek\CheckoutBR\Observer;
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if($customer->getId()){
            if(isset($params["person_type"]) && $params["person_type"]=="cpf"){
                $groupId = $this->_helper->getConfig("checkoutbr/general/customer_group_cpf");

                $customer->setCnpj();
                $customer->setSocialname();
                $customer->setIe();
            }else if(isset($params["person_type"]) && $params["person_type"]=="cnpj"){
                $groupId = $this->_helper->getConfig("checkoutbr/general/customer_group_cnpj");
            ...
            if(isset($document) && $this->_helper->getConfig("checkoutbr/general/copy_taxvat")){
