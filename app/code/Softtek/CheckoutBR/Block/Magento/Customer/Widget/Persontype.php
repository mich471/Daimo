...
class Persontype extends \Magento\Customer\Block\Widget\AbstractWidget
{
     ...
     *
     * @param Softtek\CheckoutBR\Helper\Data $helper
    ...
    {
        parent::_construct();
        //$this->setTemplate('Softtek_CheckoutBR::widget/persontype.phtml');
    }
    ...
    {
        return $this->helper->getConfig("checkoutbr/".$group."/".$field);
    }
    ...
    {
        $fieldConfig = $this->helper->getConfig("checkoutbr/".$group."/".$field."_show");
