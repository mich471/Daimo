...
class LayoutProcessor
{
    ...
    /**
     * @var \Softtek\CheckoutBR\Model\Config\Source\Streetprefix
     */
    ...
    public function getShippingFormFields($jsLayout, $numStreetLines)
    {
        ...
        // Street Line 1
        if($this->helper->getConfig("checkoutbr/general/line_number")
                && $numStreetLines >= 2) {
        ...
        // Street Line 2
        if($this->helper->getConfig("checkoutbr/general/line_neighborhood")
                && $numStreetLines >= 3) {
        ...
        // Street Line 3
        if($this->helper->getConfig("checkoutbr/general/line_complement")
                && $numStreetLines == 4) {
        ...
        $shippingAddressFieldsetChild['postcode']['component'] =
            'Softtek_CheckoutBR/js/shipping-address/address-renderer/zip-code';
        $shippingAddressFieldsetChild['postcode']['config']['elementTmpl'] =
            'Softtek_CheckoutBR/shipping-address/address-renderer/zip-code';

        // Telephone
        $shippingAddressFieldsetChild['telephone']['component'] =
            'Softtek_CheckoutBR/js/shipping-address/address-renderer/telephone';
