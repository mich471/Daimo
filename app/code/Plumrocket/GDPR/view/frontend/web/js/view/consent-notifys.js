...
define([
    ...
    'jquery',
    'uiComponent',
    'Plumrocket_GDPR/js/model/consent-notifys-modal'
], function (ko, $, Component, consentModal) {
    'use strict';

    return Component.extend({
        defaults: {
            template: 'Plumrocket_GDPR/consent-notifys'
        },
         ...
         */
        getNotifysId: function (consentId) {
            return consentId;
        },
        ...
        printContent: function (data, event) {
            ...
            printWindow.document.write('<html><head><title>' + data['checkbox_label'] + '</title>');
