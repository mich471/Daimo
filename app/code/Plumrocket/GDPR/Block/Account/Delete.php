 ...
 * @see \Plumrocket\DataPrivacy\ViewModel\Dashboard\Delete
 */
class Delete extends GDPR
{
    /**
     ...
     * @return string
     */
    public function getDeleteAction($params = [])
    {
        $isLoggedIn = $this->httpContext->getValue(\Magento\Customer\Model\Context::CONTEXT_AUTH);
        if ($isLoggedIn) {
            return $this->getUrl('prgdpr/customer/delete', $params);
        }

        return $this->getUrl('prgdpr/guest/delete', $params);
    }
