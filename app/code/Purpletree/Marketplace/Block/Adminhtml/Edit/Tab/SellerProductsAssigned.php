 ...
 */
class SellerProductsAssigned extends \Magento\Backend\Block\Template implements TabInterface
{
    /**
    ...
    {
        return $this->getUrl('purpletree_marketplace/*/sellerproductsassigned', ['_current' => true]);
    }
    /**
