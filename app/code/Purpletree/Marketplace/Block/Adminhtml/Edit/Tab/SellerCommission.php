 ...
 */
class SellerCommission extends \Magento\Backend\Block\Template implements TabInterface
{
    /**
    ...
    {
        return $this->getUrl('purpletree_marketplace/*/sellercommission', ['_current' => true]);
    }
    /**
