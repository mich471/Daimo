 ...
 */
class SellerPayments extends \Magento\Backend\Block\Template implements TabInterface
{
    /**
    ...
    {
        return $this->getUrl('purpletree_marketplace/*/sellerpayments', ['_current' => true]);
    }
    /**
