...
class Header extends \Magento\Framework\View\Element\Html\Link
{
    ...
    {
        return $this->_dataHelper->getGeneralConfig('manage_links/header_enable');
    }
    ...
    public function getLabel()
    {
        ...
        return $this->_dataHelper->getGeneralConfig('manage_links/header_text');
    }
