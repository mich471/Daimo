...
class SellerShipping extends Action
{
    /**
     * Constructor
     *
...
//        $sellershippingg = $this->dataHelper->getConfigValue('carriers/purpletreetablerate/active',$this->storeManager->getStore()->getId());
//        if ($sellerId=='' || !$moduleEnable || !$sellershippingg) {
...
//        }
        ...
        $this->_resultPage->getConfig()->getTitle()->set(__('Shipping Rates'));
