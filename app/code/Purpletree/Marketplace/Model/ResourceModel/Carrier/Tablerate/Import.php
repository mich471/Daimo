...
use Purpletree\Marketplace\Model\ResourceModel\Carrier\Tablerate\CSV\ColumnResolver;
use Purpletree\Marketplace\Model\ResourceModel\Carrier\Tablerate\CSV\ColumnResolverFactory;
use Purpletree\Marketplace\Model\ResourceModel\Carrier\Tablerate\CSV\RowException;
use Purpletree\Marketplace\Model\ResourceModel\Carrier\Tablerate\CSV\RowParser;
...
class Import
{
     ...
     */
    public function getData(ReadInterface $file, $websiteId, $conditionShortName, $conditionFullName, $bunchSize = 5000,$seller_id = NULL)
    {
        $this->errors = [];
